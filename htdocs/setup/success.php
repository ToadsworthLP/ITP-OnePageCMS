            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        Das Setup wurde erfolgreich ausgeführt. Besuchen sie das Admin-Panel, um ihre Seite zu bearbeiten.
                    </div>
                    <div class="form-group">
                        <br>
                        <a href="/admin.php" class="btn btn-primary btn-block">Zum Admin-Panel</a>
                    </div>
                </div>
            </div>
        </div>
