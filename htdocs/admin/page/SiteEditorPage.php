            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-secondary reset-button help-button"href="admin.php?page=7#v-pills-slider" target="_blank" type="submit" name="<?= $key ?>" value="" data-toggle="tooltip" data-placement="left" data-html="true" title="Brauchen Sie Hilfe?"><?php include 'mockup/inc/backend-panel/icons/help-icon.php'; ?></a>
                    </div>
                    <div class="card-body">
                        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-secondary reset-button help-button" href="admin.php?page=7#v-pills-editor" target="_blank" type="submit" name="<?= $key ?>" value="" data-toggle="tooltip" data-placement="left" data-html="true" title="Brauchen Sie Hilfe?"><?php include 'mockup/inc/backend-panel/icons/help-icon.php'; ?></a>
                    </div>
                    <div class="card-body">
                        <!-- SECTION BLOCKS -->
