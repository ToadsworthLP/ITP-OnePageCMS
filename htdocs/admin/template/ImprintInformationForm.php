<div class="col-12">
    <form method="post" action="admin.php?&action=<?= AdminActions::UPDATE_SETTINGS ?>">
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Inhaber <?php SettingsResetButton(SettingsConfig::COMPANY_OWNER) ?></label>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Firmenbuchnummer <?php SettingsResetButton(SettingsConfig::COMPANY_NUMBER) ?></label>
                    <input type="text" class="form-control" id="exampleInputEmail1"
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    <label for="exampleInputEmail1">Unternehmensgegenstand <?php SettingsResetButton(SettingsConfig::COMPANY_CORPORATE_OBJECT) ?></label>
                    <input type="text" class="form-control" id="exampleInputEmail1"
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Handelsgericht <?php SettingsResetButton(SettingsConfig::COMPANY_COMMERCIAL_COURT) ?></label>
                    <input type="text" class="form-control" id="exampleInputEmail1"
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Firmensitz <?php SettingsResetButton(SettingsConfig::COMPANY_HEADQUARTERS) ?></label>
                    <input type="text" class="form-control" id="exampleInputEmail1"
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Adresse <?php SettingsResetButton(SettingsConfig::COMPANY_LOCATION) ?></label>
                    <input type="text" class="form-control" id="exampleInputEmail1"
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Ort <?php SettingsResetButton(SettingsConfig::COMPANY_ADDRESS) ?></label>
                    <input type="text" class="form-control" id="exampleInputEmail1"
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Telefonnummer <?php SettingsResetButton(SettingsConfig::COMPANY_PHONE) ?></label>
                    <input type="text" class="form-control" id="exampleInputEmail1"
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Email <?php SettingsResetButton(SettingsConfig::COMPANY_MAIL) ?></label>
